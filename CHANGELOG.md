...
* **sdui:** add Stat icon, deltaTone and empty ([8583c6c](https://github.com/PortakiApp/portaki-sdk/commit/8583c6c9ec21bf83901bc43861d1cc9d52c375cf))
...
* **cli:** upgrade every pinned module in a monorepo ([15c4de9](https://github.com/PortakiApp/portaki-sdk/commit/15c4de90237ad3fa91717fe17a62954043091f25))

## [8.0.1](https://github.com/PortakiApp/portaki-sdk/compare/v8.0.0...v8.0.1) (2026-09-24)


### Bug Fixes

* **cli:** ignore emissions left by earlier builds ([8210653](https://github.com/PortakiApp/portaki-sdk/commit/821065329a811065785640def9e8da7eeccc8036))
...
* **cli:** warn on guest commands named like host ops ([d93ce2e](https://github.com/PortakiApp/portaki-sdk/commit/d93ce2ec9d0b73147a47935e4378e5aa954c18b9))
* **sdk:** opt-in guest flag on queries and commands ([c70bc27](https://github.com/PortakiApp/portaki-sdk/commit/c70bc272c99a90c1935393096a584dc783b6b385))

## [6.15.1](https://github.com/PortakiApp/portaki-sdk/compare/v6.15.0...v6.15.1) (2026-09-24)


### Bug Fixes

* **sdk:** derive ctx.guest from caller, not stay ([f362be5](https://github.com/PortakiApp/portaki-sdk/commit/f362be521ed18dd6e800a2552f485c250d86e884))

## [6.15.0](https://github.com/PortakiApp/portaki-sdk/compare/v6.14.0...v6.15.0) (2026-09-24)


### Features

* **manifest:** publish a version changelog ([71b96c9](https://github.com/PortakiApp/portaki-sdk/commit/71b96c90cd1686a21fe27f21b89767bc3e1e1cb3))
...
* **cli:** send listing.json on every publish ([6029999](https://github.com/PortakiApp/portaki-sdk/commit/602999936bd405a2388d500a3cdb6548d16e8fef))

## [6.9.0](https://github.com/PortakiApp/portaki-sdk/compare/v6.8.1...v6.9.0) (2026-09-23)


### Features

* **cli:** support monorepos and portaki link ([6ed4110](https://github.com/PortakiApp/portaki-sdk/commit/6ed4110b59733a01e17b7a70df3c52662aa2ff41))

## [6.8.1](https://github.com/PortakiApp/portaki-sdk/compare/v6.8.0...v6.8.1) (2026-09-23)


### Bug Fixes

* **cli:** carry built entities to sandbox manifest ([35abb02](https://github.com/PortakiApp/portaki-sdk/commit/35abb025477687d93c73f7750adaf2b027825f62))

## [6.8.0](https://github.com/PortakiApp/portaki-sdk/compare/v6.7.0...v6.8.0) (2026-09-23)


### Features

* **sdui:** add Image size with a thumb variant ([3e92df0](https://github.com/PortakiApp/portaki-sdk/commit/3e92df0b69d614decd82c59f2dada76375f22aca))

## [6.7.0](https://github.com/PortakiApp/portaki-sdk/compare/v6.6.0...v6.7.0) (2026-09-23)


### Features

* **sdk:** add guest:files permission and FileRef ([ecb1a19](https://github.com/PortakiApp/portaki-sdk/commit/ecb1a196f055ba3170ac40b849b268d4e094a09d))

## [6.6.0](https://github.com/PortakiApp/portaki-sdk/compare/v6.5.0...v6.6.0) (2026-09-23)


### Features

* **sdui:** add Chart primitive ([e3e6b88](https://github.com/PortakiApp/portaki-sdk/commit/e3e6b88e64eb71390e441db4aff025a53d2ca188))
...
* **connectors:** add Tiqets nearby products client ([4fdfddf](https://github.com/PortakiApp/portaki-sdk/commit/4fdfddf1af96d04907a6ce82c140259d070d6475))

## [6.3.1](https://github.com/PortakiApp/portaki-sdk/compare/v6.3.0...v6.3.1) (2026-09-17)


### Bug Fixes

* **cli:** give every HTTP call a deadline ([fa3aad6](https://github.com/PortakiApp/portaki-sdk/commit/fa3aad682d85b387221c1de2c7a7c4ec37b63d3d))

## [6.3.0](https://github.com/PortakiApp/portaki-sdk/compare/v6.2.0...v6.3.0) (2026-09-17)


### Features

* **cli:** run tests before publish ([43b0f07](https://github.com/PortakiApp/portaki-sdk/commit/43b0f0705d1494f85e7d18aba70ad18ce12f3ab8))
* **test-utils:** add module conformance battery ([d205b00](https://github.com/PortakiApp/portaki-sdk/commit/d205b0091b539bdf5606b831207b230b898bb8f8))
...
* **cli:** publish the built operations ([e9ec48e](https://github.com/PortakiApp/portaki-sdk/commit/e9ec48e88c6dfa03c29db157bb13c50ad93601ff))
