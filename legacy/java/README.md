...
<p align="center">
  <code>app.portaki:portaki-module-sdk</code> · <strong>1.1.0</strong><br/>
  <sub>Annotations &amp; types pour modules backend Portaki</sub>
</p>

<p align="center">
  <a href="https://github.com/PortakiApp/portaki-sdk/tree/develop/legacy/java"><img src="https://img.shields.io/badge/source-legacy%2Fjava-181717?logo=github" alt="Source"></a>
</p>
...
Les coordonnées ci-dessus pointent vers la release **1.1.0** sur **Maven Central** — voir [docs/deployment.md](../../docs/deployment.md).
...
Le SDK **React** correspondant : **`@portaki/sdk`** — [README npm](../module-sdk/README.md).
