...
Ce document résume les concepts et les types exposés par les deux SDK du dépôt [`portaki-sdk`](https://github.com/portaki/portaki-sdk).

---

## 1. SDK JavaScript (`javascript/`)
...
- Le point d’entrée publié est `javascript/dist/` (compilation `tsc`).
...
Pour publier et consommer les artefacts depuis GitHub, suivez **[deployment.md](./deployment.md)**.
