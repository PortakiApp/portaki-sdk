...
Introduit en **`portaki-module-sdk` / `@portaki/module-sdk` 0.7.0** (minor, rétrocompatible). Les modules déclarent `requiresHostSdk: "0.7.0"` lorsqu’ils utilisent des e-mails.
