...
export async function runBuild(module: PortakiFullModule, options: BuildOptions): Promise<BuildResult> {
  ...
  const manifestSlice = moduleDataManifestSlice(module)
      ...
      JSON.stringify(
        {
          ...
          operations: {
            queries: Object.keys(module.data.queries),
            commands: Object.keys(module.data.commands),
          },
        },
        null,
        2,
  ...
  await writeFile(
    ...
    [
      'Generated by @portaki/cli — do not edit by hand.',
