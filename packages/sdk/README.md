...
<p align="center">
  <a href="https://www.npmjs.com/package/@portaki/sdk"><img src="https://img.shields.io/npm/v/@portaki/sdk?logo=npm&color=CB3837&label=npm" alt="npm version"></a>
  <a href="https://github.com/PortakiApp/portaki-sdk/blob/develop/packages/sdk/LICENSE"><img src="https://img.shields.io/badge/license-MIT-22c55e" alt="License MIT"></a>
...
```bash
npm install @portaki/sdk react
# ou
pnpm add @portaki/sdk react
```
...
Manifest JSON des modules : schéma **`module.v1`** dans le dépôt [portaki-sdk](https://github.com/PortakiApp/portaki-sdk) (`schema/module.v1.json`). Le champ **`requiresHostSdk`** (semver `X.Y.Z`) indique la version minimale de **`@portaki/sdk`** avec laquelle le module a été validé — aligner sur la version publiée du paquet npm (`packages/sdk/package.json`).
