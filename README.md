...
- **Publication automatique** : à chaque **push sur `develop`** (avec changements dans `javascript/` ou `java/`), les workflows publient vers **GitHub Packages** — npm en `x.y.z-develop.<run>` et Maven en SNAPSHOT. Voir [docs/deployment.md](docs/deployment.md).
