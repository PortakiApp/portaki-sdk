...
<p align="center">
  <code>app.portaki:portaki-module-sdk</code> · <strong>0.7.0</strong><br/>
...
Les coordonnées ci-dessus pointent vers la release **0.7.0** sur **Maven Central** — voir [docs/deployment.md](../../docs/deployment.md).
